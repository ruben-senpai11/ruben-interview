      ...
      <!-- <div className="d-flex flex-column gap-4 my-10">
        ...
        <div className="socials d-flex gap-12 sm:gap-24 flex-wrap ">
          <span className="d-flex gap-2">
            ...
            <Link href="https://github.com/ruben-senpai11" target="_blank" className="d-flex gap-2">
            Github
          ...
          <span className="d-flex gap-2">
            ...
            <Link href="https://www.linkedin.com/in/ruben-white22/" target="_blank" className="d-flex gap-2">
            Linkedin
            <svg width="16" height="16" fill="currentColor" className="bi bi-arrow-up-right" viewBox="0 0 16 16">
              <path fillRule="evenodd"
                d="M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0z" />
